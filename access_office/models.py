...
class Document(models.Model):
    ...
    number_of_document = models.CharField('Номер документа', max_length=100, db_index=True, unique=True)
    ...
    comment_import = models.TextField('Комментарий ввоза', blank=True)
    comment_export = models.TextField('Комментарий вывоза', blank=True)
    ...
    auto = models.ForeignKey('Automobile', on_delete=models.CASCADE, verbose_name='Автомобиль')
